defsymphony "Beta Baller with Rotators Final_TESTPORT" {:rebalance-frequency :daily}
  (weight-equal [
    (if (> (rsi "EQUITIES::UVXY//USD" 40) 60) [
      (group "(2025) Black Swan ? V5.2 5/28/22 by Garen Phillips - SH Mod - VIXM" [
        (weight-equal [
          (if (>= (moving-average-price "EQUITIES::UVXY//USD" 4) (moving-average-price "EQUITIES::UVXY//USD" 5)) [
            (weight-equal [
              (if (> (cumulative-return "EQUITIES::UVXY//USD" 1) 50) [
                (asset "EQUITIES::BIL//USD" "BIL")
              ] [
                (weight-equal [
                  (if (< (current-price "EQUITIES::UVXY//USD" 10) (moving-average-price "EQUITIES::UVXY//USD" 3)) [
                    (asset "EQUITIES::BIL//USD" "BIL")
                  ] [
                    (weight-equal [
                      (if (> (rsi "EQUITIES::SPY//USD" 35) 35) [
                        (weight-equal [
                          (if (> (rsi "EQUITIES::UVXY//USD" 40) 75) [
                            (asset "EQUITIES::BIL//USD" "BIL")
                          ] [
                            (weight-equal [
                              (group "BSC" [
                                (weight-equal [
                                  (if (> (rsi "EQUITIES::SPY//USD" 21) 30) [
                                    (weight-equal [
                                      (if (> (rsi "EQUITIES::VIXM//USD" 21) 83) [
                                        (asset "EQUITIES::SVXY//USD" "SVXY")
                                      ] [
                                        (weight-equal [
                                          (if (> (current-price "EQUITIES::UVXY//USD" 10) (moving-average-price "EQUITIES::UVXY//USD" 4)) [
                                            (weight-equal [
                                              (if (> (moving-average-price "EQUITIES::UVXY//USD" 3) (moving-average-price "EQUITIES::UVXY//USD" 4)) [
                                                (weight-equal [
                                                  (if (> (rsi "EQUITIES::UVXY//USD" 21) 75) [
                                                    (asset "EQUITIES::BIL//USD" "BIL")
                                                  ] [
        ...
        (if (< (rsi "EQUITIES::BIL//USD" 4) (rsi "EQUITIES::IEF//USD" 9)) [
              ...
              (group "Base 2 - FTLT or Bull or Bonds (UVXY)" [
                (weight-equal [
                  (if (> (rsi "EQUITIES::QQQE//USD" 10) 79) [
                    (group "Group" [
                      (weight-specified {"UVXY" 90 "SQQQ" 10} [
                        (asset "EQUITIES::UVXY//USD" "UVXY")
                        (asset "EQUITIES::SQQQ//USD" "SQQQ")
                      ])
                    ])
          ...
          (weight-equal [
            (if (< (rsi "EQUITIES::SBND//USD" 9) (rsi "EQUITIES::HIBL//USD" 10)) [
              ...
              (weight-inverse-vol 10 [
                (filter (cumulative-return 10) (select-bottom 1) [
                  (group "Extended Frontrunner | TCCC Basic Logic" [
                    (weight-equal [
                      (if (> (rsi "EQUITIES::QQQ//USD" 10) 79) [
                        (asset "EQUITIES::UVXY//USD" "UVXY")
